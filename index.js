...
setInterval(async () => {
const statuses = [`Akinator Discord`, `with ${await client.users.cache.size} Users`, `${process.env.prefix}aki`] // Change to whatever you want
   client.user.setActivity(statuses[Math.floor(Math.random() * statuses.length)], { type: "STREAMING", url: "https://www.twitch.tv/AkinatorDiscord"})
}, 10000)
});
